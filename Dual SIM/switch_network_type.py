...
def select_preferred_network_type(driver, network_type_text):
    network_types_dict = get_all_network_types(driver)
...
def switch_network_types(driver, network_types, target_network):
    ...
    for network_type in network_types:
        if target_network in network_type:
            ...
            select_preferred_network_type(driver, network_type)
...
def main():
    open_sim_network_settings(driver, "com.android.phone:id/sim_1")
    network_types = get_all_network_types(driver)
